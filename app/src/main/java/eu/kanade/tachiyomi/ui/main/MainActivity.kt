...
import eu.kanade.presentation.more.settings.screen.about.SyChangelogDialog
...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setComposeContent {
            ...
            // SY -->
            var showSyChangelog by remember { mutableStateOf(isLaunch) }
            if (showSyChangelog) {
                SyChangelogDialog(onDismissRequest = { showSyChangelog = false })
            }
