...
fun BottomReaderBar(
    ...
    Row(
        ...
        if (ReaderBottomButton.QuickSettings.isIn(enabledButtons)) {
            IconButton(onClick = onClickQuickSettings) {
                Icon(
                    imageVector = Icons.Outlined.Tune,
                    contentDescription = stringResource(MR.strings.pref_category_general),
                )
            }
        }
